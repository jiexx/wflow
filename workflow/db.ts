...
class DB {
    ...
    async find(dbName, collName, qry, projection=null, rawsql=null, skip=null, sort=null, count=null): Promise<any> {
        return await this.configuration[this.dbtype].find(dbName, collName, qry, projection, rawsql, skip, sort, count);
    }
